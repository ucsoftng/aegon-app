                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered">
                            ...
                            @foreach($fund as $p)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-success label-lg"><i class="fa fa-{{strtolower($p->wallet->name)}}"></i> {{$p->wallet->name}}</span>
                                    </td>
                                    <td>
                                        # {{ $p->transaction_id }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @elseif($p->status == 2)
                                            <span class="badge badge-warning"><i class="fa fa-exclamation-triangle"
