...
@section('content')
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered">
                            ...
                            @foreach($withdraw as $p)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-icon btn-sm icon-left delete_button"
                                                data-toggle="modal" data-target="#DelModal"
                                                data-id="{{ $p->id }}">
                                            <i class="fa fa-send"></i> Pay
                                        </button>
                                        <button type="button" class="btn btn-danger btn-icon btn-sm icon-left ref_button"
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger btn-icon btn-sm icon-left ref_button"
                                                ...
                                                data-id="{{ $p->id }}">
                                            <i class="fa fa-exclamation-triangle"></i> Edit Date
                                        </button>
    ...
    <div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Are you sure you want to Pay This User?</strong>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="{{ route('edit-withdraw-date') }}" class="form-group">
                    @csrf
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel"><i class='fa fa-exclamation-triangle'></i> Confirmation..!
                        </h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="datetime-local" class="form-control" name="made_date">
                        </div>
                    </div>
