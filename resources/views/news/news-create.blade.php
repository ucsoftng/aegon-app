                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="title" id="" class="form-control input-lg" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea name="description" class="textarea_editor form-control" id="area1" cols="30" rows="10" required placeholder="News Description"></textarea>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" onclick="nicEditors.findEditor('area1').saveContent();"
                                                class="btn btn-info btn-block margin-top-10"><i
                                                    class="fa fa-paper-plane"></i> Create New News
                                        </button>
                                    </div>
                                </div>
                            </div>
