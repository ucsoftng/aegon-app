                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered">
                            ...
                            @foreach ($method as $cat)
                                ...
                                <tr id="task{{$cat->id}}">
                                    ...
                                    <td>{{ $basic->symbol }} {{ $cat->method_min }}
                                        to {{ $basic->symbol }} {{ $cat->method_max }}</td>
                                    <td>
                                        @if($cat->status == 1)
                                            <button type="button"
                                                    class="btn btn-danger btn-sm btn-icon icon-left delete_button"
                                        ...
                                        @else
                                            <button type="button"
                                                    class="btn btn-success btn-sm btn-icon icon-left delete_button"
                                                    data-toggle="modal" data-target="#DelModal"
                                                    data-id="{{ $cat->id }}">
                                    ...
                                    <td>
                                        <button class="btn btn-info btn-sm btn-detail btn-icon icon-left open-modal"
                                                value="{{$cat->id}}"><i class="fa fa-edit"></i> Edit Method
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-money"></i> Withdrawal Method</h4>
                ...
                <div class="modal-body">
                    <form id="frmTasks" name="frmTasks" class="form-horizontal" novalidate="">
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 col-sm-offset-1 control-label">Method Title :</label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 col-sm-offset-1 control-label">Transaction Time
                                :</label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="method_time" id="method_time" value="" type="text"
                                           required>
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 col-sm-offset-1 control-label">Fixed Charge
                                : </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="method_fix" id="method_fix" value="" type="text"
                                           required>
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 col-sm-offset-1 control-label">Percentage : </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 col-sm-offset-1 control-label">Minimum Amount
                                : </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="method_min" id="method_min" value="" type="text"
                                           required>
                                    <span class="input-group-addon">{{ $basic->currency }}</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 col-sm-offset-1 control-label">Maximum Amount
                                : </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="method_max" id="method_max" value="" type="text"
                                           required>
                                    <span class="input-group-addon">{{ $basic->currency }}</span>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-md-12 col-sm-offset-4 text-right">
                            <button type="button" class="btn btn-info btn-block btn-icon icon-left" id="btn-save"
                                    value="add"><i class="fa fa-send"></i> Save Method
                            </button>
