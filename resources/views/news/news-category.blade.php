        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <button id="btn-add" name="btn-add" style="margin-bottom: 5px;" class="btn btn-primary pull-right"><i
                                ...
                                <tr id="task{{$cat->id}}">
                                    ...
                                    <td>
                                        <button class="btn btn-info btn-sm btn-detail btn-icon icon-left open-modal"
                                                value="{{$cat->id}}"><i class="fa fa-edit"></i> Edit Category
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="modal-body">
                    <form id="frmTasks" name="frmTasks" class="form-horizontal" novalidate="">
                        ...
                        <div class="form-group error">
                            <label for="inputTask" class="col-sm-6 control-label">Category Name</label>
                            <div class="col-md-12">
