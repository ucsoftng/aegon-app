    ...
    <div class="custom-container">
        ...
        <div class="register-form mt-4">
            ...
            @if($errors->any())
                ...
                @endforeach
            @endif
            <form action="{{ route('password.request') }}" method="post" accept-charset="utf-8" id="otpsubmit">
                @csrf
                <div class="form-group text-start mb-3">
                    <input class="form-control" type="number" name="otp" placeholder="Enter OTP" value="" required>
                </div>
                ...
                <div class="form-group text-start mb-3">
                    <span><i style="color: red; font-size: 10px;">Min: 8 characters</i></span>
                    <input class="form-control" type="password" name="password" placeholder="Enter your Password" value="" required>
                </div>
                <div class="form-group text-start mb-3">
                    <input class="form-control" type="password" name="password_confirmation" placeholder="Confirm Password" value="" required>
                </div>
                <button class="btn btn-primary w-100" type="submit" id="logsub">
