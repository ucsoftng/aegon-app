    ...
    <div class="sidebar-menu">
        ...
        <div class="sidebar-menu-inner">
            ...
            <header class="logo-env">
                ...
                <div class="logo">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('assets/images') }}/{{ $general->logo }}" width="120" alt="" />
                    </a>
                </div>
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <li class="{{ Request::is('btc-payment-request') ? " opened active" : "" }}">
                    <a href="{{ route('btc-payment-request') }}">
                        <i class="fa fa-bitcoin"></i>
                        <span class="title"> BTC Fund Adding Requests</span>
                    </a>
                </li>
...
{{--                </li>--}}
                ...
                <li class="{{ Request::is('payment-manage') ? " opened active" : "" }}">
...
{{--                </li>--}}
                <li>
                    <a href="{{ route('latter-create') }}">
                        <span class="title"><i class="fa fa-envelope-open"></i> Send Mail</span>
                    </a>
                </li>
                ...
                <li class="has-sub">
                    ...
                    <ul>
                        ...
                        <li class="has-sub">
                                <a href="#">
                                    <span class="title"><i class="entypo-cog"></i> Manage Announcements</span>
                                </a>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('announcement_show') }}">
