                            ...
                            <div class="col-sm-4 text-center">
                                <div class="panel panel-success panel-pricing">
                                    ...
                                    <div style="font-size: 18px;padding: 18px;" class="panel-body text-center">
                                        <p><strong>{{ $basic->symbol }}{{ $p->minimum }} - {{ $basic->symbol }} {{ $p->maximum }}</strong></p>
                                    </div>
                                    <ul style='font-size: 15px;' class="list-group text-center bold">
                                        <li class="list-group-item"><i class="fa fa-check"></i> Fixed Charge - {{ $basic->symbol }} {{ $p->fix }}</li>
                                        <li class="list-group-item"><i class="fa fa-check"></i> Transaction Percent - {{ $p->percent }} <i class="fa fa-percent"></i> </li>
                                    </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <span style="color: green;margin-left: 10px;"><strong>{{ $basic->symbol }} {{ $p->minimum}} - {{ $basic->symbol }} {{ $p->maximum }}. Charge ({{ $basic->symbol }} {{ $p->fix }} + {{ $p->percent}}%)</strong></span>
