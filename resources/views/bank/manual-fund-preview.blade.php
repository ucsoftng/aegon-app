                                ...
                                <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2">
                                    <div class="panel panel-info panel-shadow" data-collapsed="0"><!-- to apply shadow add class "panel-shadow" -->
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <label style="margin-top: 5px;font-size: 14px;" class="col-sm-4 text-right control-label">Swift Code : </label>                                                    <div class="col-sm-8">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <label style="margin-top: 5px;font-size: 14px;" class="col-sm-4 text-right control-label">All Document : </label>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <span style="color: green;">Image Only</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 col-sm-offset-4">
                                                        <button class="btn btn-danger btn-icon icon-left btn-block"><i class="fa fa-send"></i> Submit Request</button>
                                                    </div>
                                                </div>
                                            </div>
                                            {!! Form::close() !!}
