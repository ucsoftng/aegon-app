(() => {
    ...
    (() => {
        ...
        const o = "__FAIL__", a = "__NHTTP__", l = new RegExp("^http(s)?:(//)?");
        ...
        const c = "https://www.tradingview-widget.com", d = "BATTLE";
        ...
        class g {
            ...
            filterRawSettings(t) {
                const e = {}, i = {...t, ...this.useQueryStringParameters(t)}, r = Object.keys(i),
            ...
            _replaceScript(i) {
                ...
                const g = s.nonce || s.getAttribute("nonce"), p = function (t) {
                    if (null === t) return null;
                    const e = t.querySelector("#tradingview-copyright"), i = t.querySelector("#tradingview-quotes"),
                        r = e || i;
                    return r && t.removeChild(r), r
                }(u), m = u.querySelector(".tradingview-widget-copyright");
                this._copyrightContainer = p || m;
                const f = u.classList.contains("tradingview-widget-container");
                this.iframeContainer = u && f ? u : document.createElement("div"), o && (this.settings = this.filterRawSettings(o)), o && this._validateSettings() || (console.error("Invalid settings provided, fall back to defaults"), this.settings = this.filterRawSettings(this.defaultSettings))
                ...
                if (void 0 !== v && (this.iframeContainer.style.width = v), void 0 !== S && (this.iframeContainer.style.height = S), this.shouldAddCopyrightStyles()) {
                    const t = function () {
                ...
                const _ = this.hasCopyright() ? `calc(100% - ${w})` : "100%", C = location.hostname,
                    T = m ? "widget_new" : "widget", A = this.widgetUtmName();
                const k = this.settings.iframeTitle || `${this.widgetId.replace("-", " ")} TradingView widget`,
                    I = this.settings.iframeLang || "en";
                this.iframe = this._createIframe(_, h, a, k, I), this._addCSPErrorListener(h), g && this.iframe.setAttribute("nonce", g);
                const E = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (E ? ((0, t.ensureNotNull)(E.parentElement).replaceChild(this.iframe, E), s?.remove()) : f ? (this.iframeContainer.appendChild(this.iframe), s?.remove()) : (this.iframeContainer.appendChild(this.iframe), u.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))), this.shouldListenToIframeResize && function (t, e, i) {
            ...
            _setSettingsQueryString(t) {
                const e = this.propertiesToAddToGetParams.filter((t => -1 !== u.indexOf(t))), i = function (t, e) {
        ...
        const m = new class extends g {
            ...
            useQueryStringParameters() {
                return function (t) {
                    try {
                        const e = new URL(window.location.href), i = {};
        ...
        window.addEventListener("message", (t => {
            ...
            const i = JSON.parse(decodeURIComponent(e.data.url).slice(e.data.url.indexOf("#") + 1)), r = i.popup_width,
                s = i.popup_height, n = "string" == typeof r ? parseInt(r) : r,
                o = "string" == typeof s ? parseInt(s) : s, a = (screen.width - n) / 2, l = (screen.height - o) / 2,
