...
<div class="login-wrapper d-flex align-items-center justify-content-center">
    <div class="custom-container">
        <div class="text-center px-4">
            ...
            <hr>
            <p class="mb-4">Please enter the  <strong>OTP</strong> sent to your Email. <br> Ensure you submit the current one because it expires in 30 minutes.</p>
        </div>
        <!-- Register Form -->
        <div class="otp-verify-form mt-4">
            ...
            <form action="{{route('2fa.validate')}}" method="POST">
                ...
                <div class="input-group mb-3 otp-input-group">
                    <input id="totp" type="number" class="form-control" name="totp" required autofocus>
                </div>
